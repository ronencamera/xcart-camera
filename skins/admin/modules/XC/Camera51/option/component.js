...
define('fileuploader/background-remove-option', [], function() {
  ...
  BackgroundRemoveOption = Object.extend({
    ...
    isValidImageUrl: function(url, callback) {
      ...
      editImage: function(ev){
        ...
        if( !is_null(trackId)){
            ...
            camera51.openEditorWithTrackId( {customerId: "223",
    ...
    removeClickHandler: function() {
      ...
      this.remove(_.bind(function(resultUrl, trackId) {
        if (resultUrl) {
          var self = this;
...
define('fileuploader/background-remove-controller', ['ready', 'fileuploader/background-remove-option' ], function(readyMark, BackgroundRemoveOption) {
  ...
  var self = this;
    ...
    function writeHTMLasJS(){
        ...
        document.write("    <\/div>");
        document.write("    <a id=\"camera51-btn-mark-object\" class=\"btn roboto tooltipped\"");
        document.write("       data-position=\"bottom\" data-delay=\"50\" data-tooltip=\"Draw lines to mark areas you want to keep in the image\"");
        ...
        document.write("    <\/a>");
        document.write("    <a id=\"camera51-btn-mark-background\" class=\"btn roboto tooltipped\"");
        ...
        document.write("       onclick=\"camera51.undo()\">UNDO<\/a>");
        document.write("    <br>");
